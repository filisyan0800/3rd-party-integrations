...
class Emarsys_Suite2_Model_Api_Order extends Emarsys_Suite2_Model_Api_Abstract
{
    ...
    {
        $key = 'products|' . $this->_getConfig()->getSmartinsightFtpHost() . '|' . $this->_getConfig()->getSmartinsightFtpUser() . '|' . $this->_getConfig()->getSmartinsightFtpDir() . '|' . $this->_getConfig()->getWebsiteId();
    ...
    {
        $key = 'orders|' . $this->_getConfig()->getSmartinsightFtpHost() . '|' . $this->_getConfig()->getSmartinsightFtpUser() . '|' . $this->_getConfig()->getSmartinsightFtpDir() . '|' . $this->_getConfig()->getWebsiteId();
        return Mage::getBaseDir('var') . '/' . md5($key) . '.csv';
    }
